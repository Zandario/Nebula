...
NanoStateManager = (function () {
  ...
  let init = function () {
    ...
    _data = JSON.parse(document.getElementById('nanoui:initialData').text);
   ...
   */
  let receiveUpdateData = function (jsonString) {
    let updateData;
   ...
   */
  let executeCallbacks = function (callbacks, data) {
